...
class SequentialDataset(Dataset):
    ...
    def __init__(self, dataset_type: DatasetType, dataframe_tmp: pd.DataFrame, num_timesteps: int = NUM_TIMESTEPS, planned_batch_size: int = PLANNED_BATCH_SIZE) -> None:
        """
...
if __name__ == "__main__":
    ...
    sequential_dataset = SequentialDataset(dataframe, num_timesteps=10)
