...
For interpreting the parameters of the transformer model, follow this general guide:
```
input_dim = 1
dim_feedforward = 8
...
def train_model_and_plot(num_heads, num_decoder_layers, embedding_dim, num_modes=3, base_sequence_length=300,
    ...
    num_epochs = 300  # will early stop based on asymtpotic loss, no way it goes this high
    num_sequences = 40
